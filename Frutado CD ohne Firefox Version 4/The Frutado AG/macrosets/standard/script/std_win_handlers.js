...
function win_create_edit(type) {
    ...
    if (mac.HasParam("confirmation_tab")) {
        mac.SetParam("confirmation_tab", cfg.standard.rec.input_confirm_tab);
    }
    if (mac.HasParam("confirmation_enter")) {
        mac.SetParam("confirmation_enter", cfg.standard.rec.input_confirm_enter);
    }
    if (mac.HasParam("affirmation_button")) {
        mac.SetParam("affirmation_button", cfg.standard.rec.input_confirm_button);
    }
    */
    set_default_duration(mac);

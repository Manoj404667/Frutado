...
// (standard: false)
HtmlDumper.overwrite = false;

// alle targets aus abgezogenen Seiten entfernen
// (standard: true)
HtmlDumper.remove_target = true;
...
var doc_template = ReadStringSetting("doc_template", Project.ScriptBase + "oracleNoToc_en.dot");
...
var img_dir = InstallDirectory + "macro_templates\\standard\\";

var hinweis_image = {
    hinweis: img_dir + "img\\gluehbirne.gif",
    tipp:    img_dir + "img\\gluehbirne.gif",
    info:    img_dir + "img\\auge.gif",
    warnung: img_dir + "img\\ausrufezeichen.gif",
}

// Standard-Sprache - zuletzt verwendete Sprache
var def_lang = ReadStringSetting("record_language", "de");

// verfuegbare Sprachen fuer die Aufnahme
var rec_languages = [ 
    "bg", "cs", "da", "de", "en",
    "es", "et", "fi", "fr",
    "hi", "hr", "hu", "it", "ja", "ko", "lt",
    "lv", "nl", "no", "pl", "pt", "ro", "ru",
    "sk", "sl", "sv", "tr", "tw", "uk", "zh", "el" ];

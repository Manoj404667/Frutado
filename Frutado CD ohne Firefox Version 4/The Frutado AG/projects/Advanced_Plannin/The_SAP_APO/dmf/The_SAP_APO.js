...
function msglist_0003(win_) {
    ...
    ctx.ms.explanation_long(ctx, win_, 10, 10, {
        ...
        fieldname:'',
        fieldicon:'',
        explanation_d:'<FONT size=3>After this overview&nbsp;of&nbsp;Advanced Planning Systems you are now ready to&nbsp;begin with the \"Tutorial\".</FONT>',
        type:'none',
        all_like_demo:0,
        explanation_p:'',
        in_demo:1,
...
function getWebAutomationProgramContent() {
    ...
    content.userHeader['title'] = 'The SAP APO';

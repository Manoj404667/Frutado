...
function msglist_0009(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 8, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
...
function msglist_0010(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 9, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
...
function msglist_0011(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 10, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
        dump_page:'index_0009.html',
        new_step:'Microsoft PowerPoint - [The Frutado AG]'
    ...
    ctx.ms.explanation_long(ctx, win_, 10, 10, {
        ...
        fieldname:'',
        fieldicon:'',
        explanation_d:'<FONT size=3>You are now at the end of this lesson and the Frutado AG has been completely introduced. To continue please open the folder \"Advanced Planning Systems\".',
        type:'none',
        all_like_demo:0,
        explanation_p:'',
        in_demo:1,
...
function msglist_0012(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 11, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
        dump_page:'index_0009.html',
        new_step:'Microsoft PowerPoint - [The Frutado AG]'
...
function getWebAutomationProgramContent() {
    ...
    content.userHeader['title'] = 'Planning Concept';

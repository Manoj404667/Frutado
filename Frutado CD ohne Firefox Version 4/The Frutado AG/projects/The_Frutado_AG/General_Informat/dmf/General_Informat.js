...
function msglist_0002(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 1, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
        dump_page:'index_0001.html',
        new_step:'Microsoft PowerPoint - [The Frutado AG]'
    });
    ctx.ms.explanation_long(ctx, win_, 10, 10, {
        macro_comment:'',
        fieldname:'',
        fieldicon:'',
        explanation_d:'<P align=center><FONT color=#fd0202 size=2><FONT color=#000000><FONT face=sans-serif size=5><U>Navigation</U></FONT><BR>&nbsp;<STRONG><BR></STRONG><FONT size=3>Please use the arrow keys on your keyboard for navigation next and previous<BR><BR><IMG src=\"pages/navigationkey.gif\"></FONT></FONT></FONT></P>\n<P align=center><FONT color=#fd0202><FONT color=#000000 size=3>right arrow = next topic<BR>left arrow = previous topic</FONT></FONT></P>\n<P align=center><FONT size=3>(if you dont use the keys, the simulation will play the movie after 60 sec automaticly)</FONT><FONT color=#fd0202><FONT color=#000000><BR><BR></P></FONT></FONT>',
        type:'none',
        all_like_demo:0,
        explanation_p:'',
        in_demo:1,
...
function msglist_0003(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 2, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
        dump_page:'index_0001.html',
        new_step:'Microsoft PowerPoint - [The Frutado AG]'
    ...
    ctx.ms.explanation_long(ctx, win_, 10, 10, {
        ...
        show_nav_buttons:1,
        position_h:{ FP: '0', EP: new win_.ElementRef('0:0:0:0:1:0', 'images', 0, 0, 'eep_path=\"0:0:0:0:0:0\";\r\neep_options=3;eep_version=\"6.1.0\";\r\neep_atts={tagName:\"IMG\"};\r\neep_coll={n:\"images\",i:0,ii:-1};\r\neep_parents=[{id:\"dgo_base_div\",tagName:\"DIV\"},\r\n{tagName:\"TD\"},\r\n{tagName:\"TR\"},\r\n{tagName:\"TBODY\"},\r\n{tagName:\"TABLE\"}];\r\neep_siblingTags2=\"_IMG_:FORM\";'), XY: {x:0, y:0}, XY2: {x:1, y:1}},
        position_b:{ FP: '0', EP: new win_.ElementRef('0:0:0:0:1:0', 'images', 0, 0, 'eep_path=\"0:0:0:0:0:0\";\r\neep_options=3;eep_version=\"6.1.0\";\r\neep_atts={tagName:\"IMG\"};\r\neep_coll={n:\"images\",i:0,ii:-1};\r\neep_parents=[{id:\"dgo_base_div\",tagName:\"DIV\"},\r\n{tagName:\"TD\"},\r\n{tagName:\"TR\"},\r\n{tagName:\"TBODY\"},\r\n{tagName:\"TABLE\"}];\r\neep_siblingTags2=\"_IMG_:FORM\";'), XY: {x:0.0585946, y:0.904204}, DocXY: {x:0.0585946, y:0.875853}},
        bubble_class:'StyleA',
        bubblestyle_d:'frurado',
        b_width:82,
        b_height:98,
...
function msglist_0004(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 3, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
...
function msglist_0005(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 4, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
...
function msglist_0006(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 5, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
...
function msglist_0007(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 6, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
        dump_page:'index_0004.html',
        new_step:'Microsoft PowerPoint - [The Frutado AG]'
    ...
    ctx.ms.explanation_long(ctx, win_, 10, 10, {
        ...
        fieldname:'',
        fieldicon:'',
        explanation_d:'<FONT size=3>After this general introduction to the Frutado AG please open the <A href=\"../../../frameset.html?config=projects/The_Frutado_AG/Basic_Data/dmf/Basic_Data_demo_cfg.js\" target=_blank>basic data </A>lesson.</FONT>',
        type:'none',
        all_like_demo:0,
        explanation_p:'',
        in_demo:1,
        ...
        show_nav_buttons:1,
        position_h:{ FP: '0', EP: new win_.ElementRef('0:0:0:0:1:0', 'images', 0, 0, 'eep_path=\"0:0:0:0:0:0\";\r\neep_options=3;eep_version=\"6.1.0\";\r\neep_atts={tagName:\"IMG\"};\r\neep_coll={n:\"images\",i:0,ii:-1};\r\neep_parents=[{id:\"dgo_base_div\",tagName:\"DIV\"},\r\n{tagName:\"TD\"},\r\n{tagName:\"TR\"},\r\n{tagName:\"TBODY\"},\r\n{tagName:\"TABLE\"}];\r\neep_siblingTags2=\"_IMG_:FORM\";'), XY: {x:0, y:0}, XY2: {x:1, y:1}},
        position_b:{ FP: '0', EP: new win_.ElementRef('0:0:0:0:1:0', 'images', 0, 0, 'eep_path=\"0:0:0:0:0:0\";\r\neep_options=3;eep_version=\"6.1.0\";\r\neep_atts={tagName:\"IMG\"};\r\neep_coll={n:\"images\",i:0,ii:-1};\r\neep_parents=[{id:\"dgo_base_div\",tagName:\"DIV\"},\r\n{tagName:\"TD\"},\r\n{tagName:\"TR\"},\r\n{tagName:\"TBODY\"},\r\n{tagName:\"TABLE\"}];\r\neep_siblingTags2=\"_IMG_:FORM\";'), XY: {x:0.570306, y:0.533776}, DocXY: {x:0.570306, y:0.517052}},
        bubble_class:'StyleA',
        bubblestyle_d:'frurado',
        b_width:334,
        b_height:126,
...
function msglist_0008(win_) {
    win_.evt_simple(-1, 3901);
    ctx.ms.start_tourstop(ctx, win_, 0 , {index: 7, name: '', label: 'Microsoft PowerPoint - [The Frutado AG]', jumpable: 1, visible: 1, callable: 0});
    ctx.ms.new_page(ctx, win_, 0, 10, {
        macro_comment:'',
        dump_page:'index_0004.html',
        new_step:'Microsoft PowerPoint - [The Frutado AG]'
...
function getWebAutomationProgramContent() {
    ...
    content.userHeader['title'] = 'The Frutado AG';
    ...
    sub.audio = '';
    sub.title = 'Microsoft PowerPoint - [The Frutado AG]';
    sub.jumptarget = '';
    sub.jumpable = 1;
    sub.visible = 1;
    sub.callable = 0;

...
function msglist_0004(win_) {
    ...
    ctx.ms.explanation_long(ctx, win_, 10, 10, {
        ...
        fieldname:'',
        fieldicon:'',
        explanation_d:'<FONT size=3>After this overview of the basic data of the Frutado AG please open the <A href=\"../../../frameset.html?config=projects/The_Frutado_AG/Planning_Concept/dmf/Planning_Concept_demo_cfg.js\" target=_blank>planning concept</A> lesson.</FONT>',
        type:'none',
        all_like_demo:0,
        explanation_p:'',
        in_demo:1,
...
function getWebAutomationProgramContent() {
    ...
    content.userHeader['title'] = 'Basic Data';
